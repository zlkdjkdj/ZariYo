...
export function Architecture() {
  return (
    <section id="architecture" className="py-24 px-6 max-w-6xl mx-auto border-t border-[#1c1c1e] bg-black">
      <div className="grid md:grid-cols-2 gap-16 items-center">
        
        {/* Text Left */}
        <div className="text-left">
          <span className="text-xs font-semibold tracking-wider text-[#3182f6] uppercase">Architecture</span>
          <h2 className="text-3xl md:text-4xl font-bold text-white mt-2.5 mb-6">
            고성능 동시성 제어 아키텍처.
          </h2>
          ...
          <div className="space-y-5">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="text-white font-semibold text-sm">Redis Pub/Sub 실시간 브로드캐스팅</h4>
            ...
            <div className="flex gap-3">
              <div className="w-5 h-5 rounded-md bg-[#3182f6]/10 flex items-center justify-center mt-1"><ChevronRight className="w-3.5 h-3.5 text-[#3182f6]" /></div>
              <div>
                <h4 className="text-white font-semibold text-sm">격리 수준 기반의 정합성 유지</h4>
        ...
        <div className="rounded-3xl border border-[#2c2c2e]/60 bg-[#1c1c1e] p-8 shadow-sm">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="p-4.5 rounded-2xl bg-black border border-[#2c2c2e]/50 flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-white">좌석 선택 요청 수신</p>
                  <p className="text-[#86868b] text-[10px]">Client → REST API Gateway</p>
                </div>
              </div>
              <span className="px-2.5 py-0.5 rounded-full bg-[#1c1c1e] text-[#86868b] font-medium text-[9px]">REST API</span>
            </div>
            ...
            <div className="p-4.5 rounded-2xl bg-black border border-[#2c2c2e]/50 flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-white">Redis 분산 락 획득</p>
            ...
            <div className="p-4.5 rounded-2xl bg-black border border-[#2c2c2e]/50 flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-white">상태 실시간 전파</p>
                  <p className="text-[#86868b] text-[10px]">웹소켓 게이트웨이를 경유해 전체 클라이언트에 통지</p>
                </div>
              </div>
              <span className="px-2.5 py-0.5 rounded-full bg-[#1c1c1e] text-[#86868b] font-medium text-[9px]">WebSocket</span>
            </div>
