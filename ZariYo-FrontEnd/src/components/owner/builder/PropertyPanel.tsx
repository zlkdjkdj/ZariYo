...
export function PropertyPanel({
  ...
  return (
    <div className="lg:col-span-3 bg-white dark:bg-neutral-900/60 border border-neutral-200 dark:border-white/10 rounded-none p-5 shadow-none space-y-5 select-none backdrop-blur-xl shadow-none dark:shadow-none">
      <div>
      ...
      {selectedElement ? (
        <div className="space-y-4 text-xs font-semibold">
          {/* Type info label */}
          <div className="p-3.5 bg-[#f9fafb] dark:bg-black/40 rounded-none border border-neutral-200 dark:border-white/5">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 border border-neutral-200 dark:border-white/10 bg-[#f9fafb] dark:bg-black/45 rounded-none text-xs text-[#191f28] dark:text-white focus:border-[#000000] focus:outline-none"
            />
          </div>

          {/* Width & Height info */}
          <div className="grid grid-cols-2 gap-2 text-center bg-neutral-50 dark:bg-black/30 p-3 rounded-none border border-neutral-200 dark:border-white/5">
            <div>
            ...
            {(selectedElement.type.startsWith('table-') || selectedElement.type === 'socket') && (
              <label className="flex items-center gap-2.5 cursor-pointer group">
                <input
                  ...
                  className="w-4 h-4 rounded border-neutral-300 dark:border-white/10 text-[#000000] bg-white dark:bg-black focus:ring-0 focus:ring-offset-0 cursor-pointer"
                />
        ...
        <div className="text-center py-14 text-neutral-500 bg-neutral-50 dark:bg-black/20 rounded-none border border-neutral-200 dark:border-white/5 border-dashed">
          <HelpCircle className="w-7 h-7 mx-auto mb-2 text-[#000000] opacity-80" />
      ...
      <div className="pt-4 border-t border-neutral-200 dark:border-white/5">
        <button
          type="button"
          onClick={onSave}
          className="w-full py-3.5 rounded-full bg-gradient-to-r from-[#000000] to-[#000000] text-white hover:opacity-95 cursor-pointer shadow-none text-xs font-extrabold transition-all flex items-center justify-center gap-2 hover:scale-[1.01]"
        >
