...
export function StoreMapGuide({ storeName }: StoreMapGuideProps) {
  return (
    <div className="lg:col-span-2 bg-white dark:bg-neutral-900/40 border border-neutral-200 dark:border-white/10 rounded-none p-7 flex flex-col justify-between min-h-[300px] select-none backdrop-blur-xl shadow-none dark:shadow-none">
      <div>
        <span className="text-[10px] font-extrabold text-[#000000] px-3 py-1 rounded-full bg-[#000000]/10 border border-[#000000]/20 mb-4 inline-block font-mono tracking-wider">
        ...
        <div className="w-full h-48 bg-[#f9fafb] dark:bg-black/60 rounded-none border border-neutral-200 dark:border-white/5 relative flex items-center justify-center overflow-hidden">
          {/* Grid Lines */}
          ...
          <div className="relative flex flex-col items-center z-10">
            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-[#000000] to-[#000000] text-white flex items-center justify-center shadow-none animate-bounce">
              <Store className="w-4.5 h-4.5" />
            </div>
            <span className="text-[10px] font-bold text-[#191f28] dark:text-white bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/10 px-3 py-1 rounded-full mt-3 shadow-none">
      ...
      <div className="mt-8 p-4 rounded-none bg-neutral-100 dark:bg-white/5 border border-neutral-200 dark:border-white/5 flex gap-2.5">
        <ShieldCheck className="w-5 h-5 text-[#000000] shrink-0 mt-0.5" />
