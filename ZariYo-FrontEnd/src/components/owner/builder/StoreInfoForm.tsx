  ...
  return (
    <div className="lg:col-span-3 bg-white dark:bg-neutral-900/60 border border-neutral-200 dark:border-white/10 rounded-none p-7 backdrop-blur-xl shadow-none dark:shadow-none space-y-6">
      ...
      <div className="space-y-2">
        <label className="text-[10px] font-extrabold text-[#4e5968] dark:text-neutral-400 uppercase tracking-wider pl-0.5">매장 이름 *</label>
        <input
          type="text"
      ...
      {/* Store Address */}
      <div className="space-y-2">
        <label className="text-[10px] font-extrabold text-[#4e5968] dark:text-neutral-400 uppercase tracking-wider pl-0.5">매장 상세 주소 *</label>
        <input
          type="text"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          <label className="text-[10px] font-extrabold text-[#4e5968] dark:text-neutral-400 uppercase tracking-wider pl-0.5">브레이크 타임</label>
          <div className="flex items-center gap-2">
            <input
              type="time"
        ...
        <div className="space-y-2">
          <label className="text-[10px] font-extrabold text-[#4e5968] dark:text-neutral-400 uppercase tracking-wider pl-0.5">정기 휴무일</label>
          <input
            type="text"
            value={info.holiday}
