...
export function AboutPage() {
  ...
  return (
    <div className="bg-white dark:bg-black text-[#1d1d1f] dark:text-[#f5f5f7] font-sans selection:bg-[#3182f6]/20 min-h-screen flex flex-col justify-between relative overflow-x-hidden transition-colors duration-300">
      
      {/* Background radial gradients for dynamic look */}
      <div className="absolute top-[-10%] left-[-20%] w-[80%] h-[50%] rounded-full bg-[#3182f6]/5 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[20%] right-[-10%] w-[60%] h-[50%] rounded-full bg-[#3182f6]/3 blur-[140px] pointer-events-none" />
      ...
      <main className="flex-1 max-w-5xl mx-auto px-6 py-16 w-full z-10">
        ...
        <div className="mb-8">
          <button
            onClick={() => navigate('/')}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold text-neutral-500 hover:text-black dark:text-[#a1a1a6] dark:hover:text-white hover:bg-neutral-100 dark:hover:bg-neutral-900 cursor-pointer transition-all"
          >
        ...
        <div className="text-center md:text-left mb-16 max-w-3xl">
          ...
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 text-black dark:text-white leading-tight">
            자리요(ZariYo) 이용 가이드
          </h1>
          <p className="text-sm md:text-base text-neutral-500 dark:text-[#a1a1a6] leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          {/* Card 1: 5-min holds */}
          <div className="p-8 rounded-3xl border border-neutral-200/60 dark:border-neutral-800/80 bg-white dark:bg-[#1c1c1e] shadow-[0_4px_24px_rgba(0,0,0,0.01)] transition-transform hover:scale-[1.01]">
            <div className="w-10 h-10 rounded-2xl bg-amber-500/10 text-amber-500 flex items-center justify-center mb-6">
              <AlertCircle className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold mb-3 text-black dark:text-white">1. 실시간 선점 정책</h3>
            <p className="text-xs text-neutral-500 dark:text-[#a1a1a6] leading-relaxed">
          ...
          <div className="p-8 rounded-3xl border border-neutral-200/60 dark:border-neutral-800/80 bg-white dark:bg-[#1c1c1e] shadow-[0_4px_24px_rgba(0,0,0,0.01)] transition-transform hover:scale-[1.01]">
            ...
            <h3 className="text-base font-bold mb-3 text-black dark:text-white">2. 격자 드래그 배치 빌더</h3>
            <p className="text-xs text-neutral-500 dark:text-[#a1a1a6] leading-relaxed">
          ...
          <div className="p-8 rounded-3xl border border-neutral-200/60 dark:border-neutral-800/80 bg-white dark:bg-[#1c1c1e] shadow-[0_4px_24px_rgba(0,0,0,0.01)] transition-transform hover:scale-[1.01]">
            <div className="w-10 h-10 rounded-2xl bg-emerald-500/10 text-emerald-500 flex items-center justify-center mb-6">
              <Key className="w-5 h-5" />
            </div>
            <h3 className="text-base font-bold mb-3 text-black dark:text-white">3. 백엔드 분산 락 기술</h3>
            <p className="text-xs text-neutral-500 dark:text-[#a1a1a6] leading-relaxed">
        ...
        {/* FAQ Accordeon Panel */}
        <div className="w-full bg-[#f5f5f7]/60 dark:bg-[#1c1c1e]/40 border border-neutral-200/50 dark:border-neutral-800/50 rounded-3xl p-8">
          ...
          <div className="space-y-4">
            {faqList.map((item, idx) => {
              ...
              return (
                <div 
                  key={idx} 
                  className="bg-white dark:bg-[#1c1c1e] border border-neutral-200/50 dark:border-neutral-800/80 rounded-2xl overflow-hidden transition-all shadow-sm"
                >
                  <button
                    onClick={() => toggleFaq(idx)}
                    className="w-full flex items-center justify-between p-5 text-left font-bold text-xs md:text-sm text-black dark:text-white hover:bg-neutral-50 dark:hover:bg-neutral-900/50 cursor-pointer transition-colors"
                  >
                    <span>{item.q}</span>
                  ...
                  {isOpen && (
                    <div className="p-5 pt-0 text-xs md:text-sm text-neutral-500 dark:text-[#a1a1a6] leading-relaxed border-t border-neutral-100 dark:border-neutral-900/50">
                      {item.a}
                    </div>
                  )}
                </div>
