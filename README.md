...
<div align="center">
  <img src="docs/assets/zariyo_real_landing.png" alt="ZariYo Actual Frontend Landing Page" width="90%"/>
</div>
...
```
ZariYo/
├── docs/assets/             # README 서비스 실제 프론트엔드 스크린샷 자산 (zariyo_real_landing.png)
