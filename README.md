...
<div align="center">
  <img src="docs/assets/zariyo_real_landing.png" alt="ZariYo Service Main Landing Page" width="90%"/>
</div>
...
```
ZariYo/
├── docs/assets/             # README 전용 사용자 지정 실제 서비스 스크린샷 자산 (zariyo_real_landing.png)
