...
<div align="center">
  <img src="docs/assets/zariyo_main_landing.png" alt="ZariYo Service Main Landing Page" width="90%"/>
</div>
...
```
ZariYo/
├── docs/assets/             # 사용자 직접 업로드 원본 라이트모드 스크린샷 자산 (zariyo_main_landing.png)
